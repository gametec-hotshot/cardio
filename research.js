...
class ResearchPage {
    ...
    // Show notification
    // Ensure NotificationUtility is available in the global scope or imported correctly
    // import { NotificationUtility } from './notification-utility.js'; // Uncomment if using a module system
    
    showNotification(message, type = 'info') {
        NotificationUtility.show(message, type);
    }
}
